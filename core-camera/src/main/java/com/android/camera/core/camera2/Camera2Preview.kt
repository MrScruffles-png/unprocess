...
fun Camera2Preview(
    ...
    DisposableEffect(lifecycleOwner, controller) {
        ...
        // A controller created while the Activity is already RESUMED will not receive a historical
        // ON_RESUME event, so open it explicitly. Front/rear switching is serialized inside the
        // same controller and waits for CameraDevice.StateCallback.onClosed.
            ...
            modifier =
                modifier
                    ...
                    .pointerInput(controller) {
                        detectTapGestures(
                            onTap = { offset ->
                                if (controller.isTapFocusEnabled()) {
